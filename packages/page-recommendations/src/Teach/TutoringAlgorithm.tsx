    ...
    constructor({ variation, studentName, stake, canIssueBadge, skill, hasTuteeUsedSlonig, t }: TutoringAlgorithmProps) {
        ...
        const askStudentToRepeatTheAnswer = new AlgorithmStage(
            ...
            [
                ...
                { title: t('🗣 Show {{studentName}} the correct solution to the exercise they created and ask them to repeat it from memory', { replace: { studentName: studentName } }), text: '' },
            ],
        ...
        const provideFakeAnswer = new AlgorithmStage(
            ...
            [
                ...
                { title: t('🗣 Give {{studentName}} a wrong answer to the exercise they created', { replace: { studentName: studentName } }), text: '' },
                { title: t('🗣 Ask {{studentName}} to correct', { replace: { studentName: studentName } }), text: '' },
            ],
