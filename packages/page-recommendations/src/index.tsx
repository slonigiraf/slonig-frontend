...
import { getValidLetters,createAndStoreLetter, storeInsurances, storePseudonym, storeSetting, deleteSetting, getSetting } from './utils.js';
...
export { db, Letter, useCounter, DBImport, DBExport, getValidLetters, createAndStoreLetter, storeInsurances, storePseudonym, storeSetting, deleteSetting, getSetting };
