...
import { createAndStoreLetter, storeInsurances, storePseudonym, storeSetting, deleteSetting } from './utils.js';
...
export { useCounter, DBImport, DBExport, createAndStoreLetter, storeInsurances, storePseudonym, storeSetting, deleteSetting };
