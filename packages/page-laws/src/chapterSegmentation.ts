...
export interface ChapterPageEvidence {
  excerpt: string;
  headings: Array<{ confidence?: number; line?: number; source: 'mathpix' | 'mmd'; text: string; type: 'section_header' | 'title' }>;
  pageNumber: number;
}
