...
export const GENERATED_EXERCISES_PER_CONCEPT = 1;
...
export const EXERCISE_ABILITIES_SYSTEM_PROMPT = (language: string, chapterTitle: string): string => {
  return `Write strictly in ISO language ${language}. Use <kx>...</kx> for all formulas. Return complete valid JSON; do not omit a conversion merely because another item is difficult. Every Exercise in this request belongs to chapter ${chapterTitle}; do not use or combine context from another chapter.`;
};
