...
Every learner-facing numeric literal in title, description, and solution must be treated as a mathematical expression and enclosed in <kx>...</kx>, including standalone counts and numbers next to units. Do not leave learner-facing numbers as plain text even when no other mathematical notation is present. Do not apply this number-markup rule to imageDescription or solutionImageDescription because those are semantic generation prompts rather than learner-facing text. Use <kx>...</kx> for every other mathematical formula or expression as well, never dollar-delimited LaTeX, and escape every LaTeX backslash for valid JSON. Copy conceptIndex. Return only JSON in this shape: {"exercises":[{"conceptIndex":0,"title":"...","description":"succinct task","solution":"concise correct solution","imageDescription":"","solutionImageDescription":""}]}.`;
